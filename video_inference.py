...
with mp_pose.Pose(
    ...
    while cap.isOpened():
        ...
        x = np.array([cal_rad(arm_left)[0], cal_rad(arm_left)[1], cal_rad(arm_right)[0], cal_rad(arm_right)[1], cal_rad(leg_left)[0], cal_rad(leg_left)[1], cal_rad(leg_right)[0], cal_rad(leg_right)[1]])
